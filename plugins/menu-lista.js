...
let menu = `${lenguajeGB['smsConfi2']()} *${user.genero === 0 ? '💓' : user.genero == 'Ocultado 🕶️' ? `🕶️` : user.genero == 'Mujer 🚺' ? `🚺` : user.genero == 'Hombre 🚹' ? `🚹` : '👤'} ${user.registered === true ? taguser : taguser} 💖*
...
┃
┃✅ *_OFICIAL ARLETTE_* ✅
┃➺ _${usedPrefix}cuentasoficiales | arletteoficial_
┃
*╰━━━━━━━━━━━━━⬣*`.trim()
await conn.sendFile(m.chat, gataImg.getRandom(), 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 🐈‍⬛ 𝑨𝒓𝒍𝒆𝒕𝒔𝒊𝒕𝒂 𝑩𝒐𝒕 ❤ ', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu.getRandom()}}}) 
...
handler.command = /^(menul|menulist|menulista|menul\?)$/i
