...
await conn.sendFile(m.chat, gataImg.getRandom(), 'lp.jpg', info, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '🐈‍⬛ 𝑨𝒓𝒍𝒆𝒕𝒔𝒊𝒕𝒂 𝑩𝒐𝒕 ❤', previewType: 0, thumbnail: imagen4, sourceUrl: accountsgb.getRandom()}}}) 
...
handler.command = /^(infobot|informacionbot|infoarlette|informaciónarlet|informaciona)$/i
