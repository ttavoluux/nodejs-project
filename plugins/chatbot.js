...
if (/^Reglass$/i.test(m.text) ) { //sin prefijo 
conn.reply(m.chat, `*📌 Reglas 💖*

*Obedece a mi dueña: Arletsita <3 ❤*


*𝓑𝔂: 𝓐𝓻𝓵𝓮𝓽𝓼𝓲𝓽𝓪 𝓫𝓸𝓽 💕*`, fkontak, m)}

if (/^Qgggggg|Qgggggg?|Qgggggg?|Qgggggg|Qgggggg|Qgggggg|Qgggggg|Qgggggg$/i.test(m.text) ) {
