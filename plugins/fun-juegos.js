...
ptt: true })}
 ...
 if (command == 'top') {
if (!text) return m.reply(` *⚠️ Accion mal usada .top | texto* `)
let top = ` *TOP 10 ${text.toUpperCase()} DEL GRUPO* 🐈‍⬛
...
if (command == 'top1') {
if (!text) return m.reply(` *⚠️ Accion mal usada .top | texto* `)
let top = ` *🥇 LA/EL MAS ${text.toUpperCase()} DEL GRUPO 😍* 
...
if (command == 'top3') {
if (!text) return m.reply(` *⚠️ Accion mal usada .top | texto* `)
let top = ` *🥇 LAS 3 MAS ${text.toUpperCase()} DEL GRUPO 😍* 
