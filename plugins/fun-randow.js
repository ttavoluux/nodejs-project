...
global.piropo = [
    ...
    "Me gustaría ser sol para poder iluminar tu vida cada día.",
    "Si fueras una estrella, serías la más brillante del universo.",
    "Me gustaría ser la luna para poder mirarte toda la noche.",
    "Si fueras un sueño, no querría despertar nunca.",
    "Me gustaría ser viento para acariciar tu rostro.",
    "Si fueras una flor, serías la más hermosa de todas.",
    "Me gustaría ser café para acompañarte en tus mañanas.",
    "Si fueras un libro, serías la novela más interesante.",
    "Me gustaría ser nube para flotar cerca de ti todo el tiempo.",
    "Si fueras un poema, serías el más bello que jamás haya existido.",
    "Me gustaría ser una melodía para sonar en tus pensamientos todo el día.",
    "Si fueras una pintura, serías una obra maestra.",
    "Me gustaría ser estrella fugaz para pedir un deseo por ti.",
    "Si fueras un río, me encantaría ser la corriente que te lleva.",
    "Me gustaría ser el aire para poder entrar en tu vida sin que te des cuenta.",
    "Si fueras una joya, serías el diamante más precioso.",
    "Me gustaría ser un reflejo para ver mi rostro en tu sonrisa.",
    "Si fueras una estación, serías la primavera, siempre hermosa y llena de vida.",
    "Me gustaría ser un abrazo para envolver tu alma.",
    "Si fueras un vino, serías el más dulce y añejo.",
    "Si fueras una nube, yo sería la lluvia, solo para mojarte un poquito.",
    "Si fueras una canción, serías mi favorita en repeat.",
    "Si fueras un ángel, te robaría las alas para tenerte siempre cerca.",
    "Me gustaría ser tu sombra, para seguirte a donde vayas.",
    "Eres como un buen libro, no quiero que se termine nunca.",
    "Si fueras un jardín, serías el más colorido y fragante.",
    "Si fueras una estrella, no necesitaría pedir deseos, porque ya te tengo.",
    "Eres tan dulce que me haces olvidar que el azúcar existe.",
    "Si fueras una joya, serías un rubí, única y brillante.",
    "Si fueras mi sueño, nunca querría despertar.",
    "Si fueras un tesoro, sería el más afortunado de encontrarlo.",
    "Tu sonrisa ilumina mi día más que el sol.",
    "Eres la razón por la que el sol brilla más hoy.",
    "Si fueras un café, serías el más fuerte y delicioso.",
    "Si fueras una flor, sería la rosa más roja y viva.",
    "Eres el único pensamiento que no me deja dormir.",
    "Eres como una estrella fugaz, rara y maravillosa.",
    "Si fueras una luna, yo sería el mar, siempre te buscaría.",
    "Me encantaría ser tu espejo para reflejar tu belleza todos los días.",
    "Si fueras una carta, serías la más hermosa que jamás haya existido.",
    "Si fueras un caramelo, sería el más dulce de todos.",
    "Me gustaría ser pintor solo para dibujar tu sonrisa.",
    "Si fueras una melodía, estarías sonando en mi mente todo el día.",
    "Si fueras un paisaje, serías el atardecer más hermoso.",
    "Eres el sueño que nunca quiero despertar.",
    "Me gustaría ser tu almohada para poder estar cerca de ti mientras duermes.",
    "Si fueras una pizza, serías la más deliciosa y completa.",
    "Eres como un diamante, brillante y única.",
    "Tu risa es la melodía que mi corazón desea escuchar.",
    "Eres el sol que ilumina mi cielo nublado.",
    "Si fueras un chocolate, serías el más suave y dulce.",
    "Cada vez que te miro, mi mundo se llena de colores.",
    "Si fueras un libro, serías una novela romántica que no quiero dejar de leer.",
    "Si fueras un perfume, serías el más embriagador de todos.",
    "Eres como una tormenta, imposible de ignorar y fascinante.",
    "Si fueras una estrella, iluminarías toda la galaxia con tu luz.",
    "Eres como el café, me haces sentir vivo y con energía.",
    "Si fueras una canción, serías mi banda sonora favorita.",
    "Si fueras una película, serías mi romance favorito.",
    "Tu mirada tiene la magia de un hechizo.",
    "Si fueras un río, me encantaría ser el agua que fluye a tu lado.",
    "Eres mi razón para sonreír sin razón.",
    "Si fueras un reloj, serías el minuto perfecto que siempre quiero tener.",
    "Tu belleza no se puede describir con palabras, solo con sentimientos.",
    "Eres como un buen vino, solo mejoras con el tiempo.",
    "Tu voz es el refugio que necesito en días grises.",
    "Si fueras un regalo, serías el más valioso de todos.",
    "Eres como una chispa de fuego, tan caliente y radiante.",
    "Si fueras un mapa, serías el destino que siempre quiero encontrar.",
    "Eres la inspiración de mi poesía favorita.",
    "Tu risa es mi canción favorita, no me canso de escucharla.",
    "Si fueras un laberinto, no me importaría perderme en ti.",
    "Eres tan bonita que hasta el sol se sonroja cuando te mira.",
    "Si fueras un mar, me encantaría ser el pez que navega en tus aguas.",
    "Eres como una flor en primavera, siempre fresca y llena de vida.",
    "Tu sonrisa es como una brújula, siempre me indica el camino hacia la felicidad.",
    "Si fueras una nube, serías la más suave y perfecta del cielo.",
    "Si fueras un café, serías el más fuerte y sabroso.",
    "Si fueras un libro, serías el que no quiero dejar de leer.",
    "Eres como un sueño, tan hermosa que no quiero despertar.",
    "Si fueras un cuadro, serías el que mejor cuelga en mi corazón.",
    "Me gustaría ser el viento para acariciar tu rostro cada día.",
    "Eres la melodía que mi corazón quiere escuchar una y otra vez.",
    "Si fueras una estrella, yo sería la luna, para verte cada noche.",
    "Si fueras un sol, serías el que nunca se pone.",
    "Si fueras un poema, serías el verso perfecto.",
    "Eres tan brillante que ni el sol puede opacar tu luz.",
    "Si fueras un caramelo, serías el más dulce de todos.",
    "Si fueras una princesa, yo sería tu caballero para protegerte siempre.",
    "Me gustaría ser el sol para iluminarte desde el amanecer hasta el atardecer.",
    "Eres mi sueño hecho realidad, una belleza inalcanzable.",
    "Si fueras un tesoro, pasaría toda mi vida buscándote.",
    "Si fueras una flor, serías una rosa, rara y única.",
    "Eres como el chocolate, dulce y irresistible.",
    "Si fueras un mar, yo sería el barco que navega en tus aguas.",
    "Me gustaría ser un espejo para verte todos los días.",
    "Eres como un diamante, imposible de comparar con algo más.",
    "Si fueras una estación, serías la primavera, porque llegas a mi vida con todo el color y la frescura.",
    "Si fueras un perfume, serías el más delicioso que he olido.",
    "Eres como un arco iris, traes color y esperanza a mis días grises.",
    "Si fueras una canción, serías mi favorita, siempre en repetición.",
    "Tu mirada ilumina el lugar más que las luces de la ciudad.",
    "Si fueras una estrella fugaz, haría un deseo por ti cada noche.",
    "Eres tan brillante que ni el sol puede competir contigo.",
    "Si fueras una copa de vino, serías el mejor y más exquisito.",
    "Si fueras una luna, serías la más llena y hermosa.",
    "Eres como un faro, siempre iluminando el camino en la oscuridad.",
    "Si fueras un perfume, sería el aroma que nunca me cansaría de oler.",
    "Si fueras un dibujo, serías el más perfecto que jamás haya existido.",
    "Tu risa es mi melodía favorita, siempre me alegra el día.",
    "Si fueras un diamante, serías el más brillante y valioso del mundo.",
    "Si fueras un sol, serías el más cálido y acogedor.",
    "Eres el sueño que quiero vivir, la fantasía que quiero hacer realidad.",
    "Si fueras una joya, serías la más rara y preciosa.",
    "Si fueras un paisaje, serías un atardecer sobre el mar, inolvidable y lleno de colores.",
    "Eres mi sol en los días nublados, la luz en mis momentos oscuros.",
    "Si fueras una flor, serías la flor más fragante y hermosa del jardín.",
    "Si fueras una melodía, serías la canción que no puedo dejar de cantar.",
    "Si fueras un libro, serías el más apasionante y lleno de aventuras.",
    "Eres el reflejo de todo lo hermoso que hay en el mundo.",
    "Si fueras un viaje, serías la aventura más emocionante de todas.",
    "Tu voz es el bálsamo que sana mi alma y mi corazón.",
    "Si fueras un sol, serías el que nunca deja de brillar.",
    "Si fueras una pintura, serías la obra maestra que todos admiran.",
    "Si fueras una estrella, serías la que nunca se apaga.",
    "Eres como un sueño hecho realidad, tan hermosa que no quiero despertar.",
    "Si fueras un paisaje, serías un atardecer sobre el mar, imposible de olvidar.",
    "Me gustaría ser un poema para describir toda tu belleza.",
    "Si fueras una canción, serías mi letra favorita.",
    "Eres tan dulce que hasta el azúcar se sonroja.",
    "Si fueras una joya, serías el diamante más brillante y perfecto.",
    "Tu sonrisa es la luz que ilumina mis días oscuros.",
    "Si fueras un libro, serías mi lectura favorita que nunca quiero terminar.",
    "Si fueras un río, me gustaría ser el agua que fluye por tu corazón.",
    "Eres como una estrella fugaz, rara y única, pero hermosa.",
    "Si fueras un sol, serías el que brilla con más fuerza.",
    "Si fueras una flor, serías la más bella y delicada del jardín.",
    "Eres la razón por la que el sol brilla más hoy.",
    "Si fueras una pintura, serías una obra maestra digna de admirar.",
    "Tu risa es como música para mis oídos, la melodía más dulce.",
    "Si fueras un perfume, serías el que deja huella en cada lugar.",
    "Si fueras una nube, serías la más suave y esponjosa del cielo.",
    "Si fueras un fuego, serías el que arde en mi corazón.",
    "Tu mirada tiene la capacidad de derretir mi alma.",
    "Si fueras un sueño, serías el que nunca quiero despertar.",
    "Si fueras una estrella, yo sería el cielo, solo para verte brillar.",
    "Eres la luna que ilumina mi noche más oscura.",
    "Si fueras un diamante, serías el más raro y brillante del mundo.",
    "Si fueras un caramelo, serías el más dulce y tentador.",
    "Eres tan hermosa que hasta las flores se ponen celosas.",
    "Si fueras un libro, serías mi novela favorita, la que siempre quiero leer.",
    "Si fueras una canción, serías la que no me canso de escuchar.",
    "Eres como el sol, siempre iluminando mi vida con tu presencia.",
    "Si fueras un café, serías el más fuerte y delicioso de todos.",
    "Eres tan dulce que mi corazón se acelera solo con verte.",
    "Si fueras una pintura, serías la más colorida y vibrante de todas.",
    "Eres como una joya rara, imposible de encontrar en cualquier lugar.",
    "Si fueras un paisaje, serías un campo de flores en pleno verano.",
    "Tu belleza es como el océano, infinita e imparable.",
    "Si fueras un árbol, serías el más alto y majestuoso del bosque.",
    "Eres mi sol en los días nublados, mi luz en la oscuridad.",
    "Si fueras una estrella fugaz, pediría un deseo por ti cada vez que aparezcas.",
    "Si fueras una luna, serías la más brillante de todas.",
    "Eres como un abrazo cálido, siempre reconfortante y lleno de amor.",
    "Si fueras un río, me encantaría ser la corriente que te sigue.",
    "Si fueras un sueño, serías el más hermoso que jamás haya existido.",
    "Tu belleza es tan grande que ni las palabras pueden describirla.",
    "Si fueras un volcán, serías el que hace erupción de amor.",
    "Si fueras un sol, serías el que ilumina mi vida todos los días.",
    "Si fueras un chocolate, serías el más suave y dulce que he probado.",
    "Eres como el viento, incontrolable y fascinante.",
    "Si fueras una joya, serías la más preciosa y codiciada.",
    "Eres mi razón para sonreír sin razón alguna.",
    "Si fueras un diamante, brillarías más que cualquier estrella en el cielo.",
    "Si fueras una flor, serías la que todos quieren tener en su jardín.",
    "Eres mi luz en la oscuridad, mi guía hacia la felicidad.",
    "Si fueras un océano, me encantaría ser el barco que navega sobre tus aguas."
]

global.chiste = ["¿Cuál es el último animal que subió al arca de Noé? El del-fin..",
    ...
    "¿Cómo se dice pelo sucio en chino? Chin cham pu.", "Había una vez un niño tan, tan, tan despistado que... ¡da igual, me he olvidado del chiste!",
    ...
    "¿Por qué las focas miran siempre hacia arriba? ¡Porque ahí están los focos!", "Camarero, ese filete tiene muchos nervios. Pues normal, es la primera vez que se lo comen.",
    ...
    "¿Qué le dice un gusano a otro gusano? — ¡Voy a dar una vuelta a la manzana!",
    "— ¡Estás obsesionado con el fútbol! — No, no estoy obsesionado, es que llevo toda la vida viéndolo.",
    "¿Qué le dice un jardinero a otro? — ¡Nos vemos cuando podamos!",
    "¿Cómo se llama el amigo que nunca llega a tiempo? ‘Tarde’.",
    "— ¡Estás deprimido! — No, estoy ‘sub’ pero no ‘deprimido’.",
    "¿Qué le dice una cebolla a otra cebolla? — ¡Nos vemos en la olla!",
    "Si el dinero no da la felicidad, ¿por qué todos los ricos son felices?",
    "¿Cómo se dice pañuelo en japonés? Saka-moko.",
    ...
    "¿Por qué el semáforo nunca juega al escondite? Porque siempre se pone rojo cuando alguien lo mira.",
    "— Oye, ¿tú sabes cómo se llama este animal? — No. — ¡Es un loro! — ¡Ah! No lo sabía.",
    "¿Por qué las focas miran siempre hacia arriba? ¡Porque ahí están los focos!",
    "— ¿Qué le dijo el 0 al 8? — ¡Vaya, qué bonito cinturón!",
    ...
    "— ¿Por qué no puedes confiar en los átomos? — Porque hacen todo a nivel molecular.",
    "¿Qué le dice un gusano a otro gusano? — ¡Voy a dar una vuelta a la manzana!",
    ...
    "¿Qué le dice un jardinero a otro? — ¡Nos vemos cuando podamos!",
    "¿Cómo se llama el amigo que nunca llega a tiempo? ‘Tarde’.",
    "¿Qué le dijo una cebolla a otra cebolla? — ¡Nos vemos en la olla!",
    "¿Qué le dice un gusano a otro gusano? — ¡Voy a dar una vuelta a la manzana!",
    "Si el dinero no da la felicidad, ¿por qué todos los ricos son felices?",
    "— Oye, ¿tú sabes cómo se llama este animal? — No. — ¡Es un loro! — ¡Ah! No lo sabía.",
    "¿Cómo se llama el campeón de buceo japonés? Tokofondo. ¿Y el subcampeón? Kasitoko.",
    ...
    "¿Qué le dice una cebolla a otra cebolla? — ¡Nos vemos en la olla!",
    "¿Qué le dice un gusano a otro gusano? — ¡Voy a dar una vuelta a la manzana!",
    "¿Qué le dice un árbol a otro árbol? — ¡Nos vemos cuando podamos!",
    ...
    "¿Qué le dice un jardinero a otro? — ¡Nos vemos cuando podamos!",
    "¿Cómo se llama el amigo que nunca llega a tiempo? ‘Tarde’.",
    "— ¡Hola, soy nuevo aquí! — ¿Nuevo en qué? — ¡En ser tu amigo!",
    ...
    "¿Por qué los pájaros no usan WhatsApp? Porque ya tienen Twitter.",
    "¿Por qué el semáforo nunca juega al escondite? Porque siempre se pone rojo cuando alguien lo mira.",
    "¿Qué le dice el 0 al 8? — ¡Vaya, qué bonito cinturón!",
    "¿Qué le dice una cebolla a otra cebolla? — ¡Nos vemos en la olla!",
    "¿Por qué los esqueletos no pelean entre ellos? Porque no tienen agallas.",
    "¿Cuál es el café más peligroso del mundo? El ex-preso.",
    "¿Qué le dijo una vaca a otra vaca? — ¡Te veo en el pasto!",
    "¿Cómo se llama el amigo que nunca llega a tiempo? ‘Tarde’.",
    "¿Por qué las focas miran siempre hacia arriba? ¡Porque ahí están los focos!",
    "¿Qué le dice un gusano a otro gusano? — ¡Voy a dar una vuelta a la manzana!",
    "— Mamá, en el colegio me llaman distraído. — Juanito, tú vives en la casa de enfrente.",
    "¿Por qué el libro de matemáticas se deprimió? Porque tenía demasiados problemas.",
    "¿Cuál es el colmo de un electricista? No encontrar su corriente de trabajo.",
    "¿Sabes cómo se dice pañuelo en japonés? Saka-moko.",
    "¿Qué le dice un árbol a otro árbol? — ¡Nos vemos cuando podamos!",
    "¿Qué le dijo el 0 al 8? — ¡Vaya, qué bonito cinturón!",
    "¿Qué le dice un jardinero a otro? — ¡Nos vemos cuando podamos!",
    "¿Por qué los pájaros no usan Facebook? Porque ya tienen Twitter.",
    ...
    "¿Qué le dijo el 0 al 8? — ¡Vaya, qué bonito cinturón!",
    "¿Qué hace una vaca cuando sale el sol? Sombra.",
    "¿Sabes por qué el libro de matemáticas se deprimió? Porque tenía demasiados problemas.",
    "¿Qué le dice un gusano a otro gusano? — ¡Voy a dar una vuelta a la manzana!",
    "¿Por qué las focas miran siempre hacia arriba? ¡Porque ahí están los focos!",
    "¿Cómo se llama el amigo que nunca llega a tiempo? ‘Tarde’.",
    "¿Qué le dice el 0 al 8? — ¡Vaya, qué bonito cinturón!",
